...
usermod -a -G wheel -s /bin/bash ${username}
echo "${uname}:${userpass}" | chpasswd

mkinitcpio -P
echo "root:${password}" | chpasswd

pacman -Syu --noconfirm hyprland waybar wofi swaybg swaylock alacritty grim pulseaudio pulseaudio-ctl pavucontrol bluez bluez-utils networkmanager
